...
Tags SHALL be rendered as badges in the viewer, with the first tag styled distinctly as a "mood" indicator.
...
Saving an entry SHALL fully replace the entry for that date.
